...
SDK. Plugin id: `example` · version `1.0.0`.
...
routes, Dashboard*/Profile* components, a store, translations, an event subscription, menu items.
...
- Original sprint report: `docs/dev_log/20260619/reports/04-A02-plugin-system.md` in the umbrella repo.
